...
!function (a, b) {
    "use strict";
    b.module("angular-moment", ["gdi2290.moment"]), b.module("angular-momentjs", ["gdi2290.moment"]), b.module("ngMoment", ["gdi2290.moment"]), b.module("ngMomentjs", ["gdi2290.moment"]), b.module("ngMomentJS", ["gdi2290.moment"]), b.module("gdi2290.amTimeAgo", []), b.module("gdi2290.amDateFormat", []), b.module("gdi2290.moment-service", []), b.module("gdi2290.moment", ["gdi2290.moment-service", "gdi2290.amDateFormat", "gdi2290.amTimeAgo"]), b.module("gdi2290.amDateFormat").filter("amDateFormat", function (a) {
        return function (b, c) {
            return"undefined" == typeof b || null === b ? "" : (!isNaN(parseFloat(b)) && isFinite(b) && (b = new Date(parseInt(b, 10))), a.then ? void a().then(function (a) {
                return a(b).format(c)
            }) : a(b).format(c))
        }
    }), b.module("gdi2290.amTimeAgo").directive("amTimeAgo", function (a, c) {
        function d(a) {
        ...
        var b = !1, c = "//cdnjs.cloudflare.com/ajax/libs/moment.js/2.5.0/moment.min.js";
        this.asyncLoading = function (a) {
            return b = a || b, this
        }, this.scriptUrl = function (a) {
            return c = a || c, this
        }, this.$get = function (c, d, e, f) {
            var g = e.defer(), h = f.moment;
            if (b) {
                var i = function () {
                    c(function () {
                        g.resolve(f.moment)
