...
//    Page<Comment> findByThreadIdAndStatusInAndFingerprintGreaterThan(String id, List<Comment.Status> status, String fromFingerprint, Pageable pageable);
//    Page<Comment> findByThreadIdAndStatusInAndFingerprintLessThan(String id, List<Comment.Status> status, String toFingerprint, Pageable pageable);
//    Page<Comment> findByThreadIdAndStatusInAndFingerprintGreaterThanAndFingerprintLessThan(String id, List<Comment.Status> status, String fromFingerprint, String toFingerprint, Pageable pageable);
